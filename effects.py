...
class WaterTileEffect(RobotEffect):
    slowdown = 90
    ang_slowdown = 3
    ...
    def apply(self, robot, delta_time=0):
        ...
        robot.sim_body.max_velocity -= WaterTileEffect.slowdown
        robot.sim_body.max_ang_velocity -= WaterTileEffect.ang_slowdown
...
class FireTileEffect(RobotEffect):
    slowdown = -60
    ang_slowdown = -2
    ...
    def apply(self, robot, delta_time=0):
        ...
        robot.sim_body.max_velocity -= FireTileEffect.slowdown
        robot.sim_body.max_ang_velocity -= FireTileEffect.ang_slowdown
