...
class Robot:
    def __init__(self, radius=15, position=Vector(0.0, 0.0), rotation=0.0):
        self.radius = radius
    ...
    def draw(self, qp):
        ...
        qp.drawEllipse(QPoint(round(self.position.x), round(self.position.y)), self.radius, self.radius)
